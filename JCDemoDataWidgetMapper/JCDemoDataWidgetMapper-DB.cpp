 ...
 * @note
 */
QString JCDemoDataWidgetMapper::databaseFile()
{
    // database name
 ...
 * @note
 */
QString JCDemoDataWidgetMapper::databaseConnectionName()
{
 ...
 * @note
 */
bool JCDemoDataWidgetMapper::connectDatabase()
{
    // database name
 ...
 * @note
 */
bool JCDemoDataWidgetMapper::disconnectDatabase()
{
    return true;
}
